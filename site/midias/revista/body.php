<?php
	...
	$sql = "SELECT * FROM blog WHERE cat_id = 7 ORDER BY blog_id DESC LIMIT $inicio, $total_reg";
...
<div class="container">
	...
	<!-- Chamadas Blog -->
	<h2 class="featurette-heading">Revista Mensal</h2>
	<?php
	...
	<nav class="pull-right">
		<ul class="pagination">
			<?php
				...
				if(($pc>=1) && ($ant !=0)){
					echo ("<li><a href='".site."/midias/revista?p=$ant' aria-label='Anterior'>
									<span aria-hidden='true'>&laquo;</span> Anterior
								</a></li>");
					echo ("<li><a href='".site."/midias/revista?p=$ant'>$ant</a></li>");
				}
								
				echo ("<li class='active'><a href='".site."/midias/revista?p=$pc'>$pc</a></li>");
								
				if($pc<=$tp){
					echo ("<li><a href='".site."/midias/revista?p=$prox'>$prox</a></li>");
					echo("<li><a href='".site."/midias/revista?p=$prox' aria-label='Próximo'>Próximo 
