<?php
	...
	$sql = "SELECT * FROM blog WHERE cat_id = 6 ORDER BY blog_id DESC LIMIT $inicio, $total_reg";
...
<div class="container">
	...
	<!-- Chamadas Blog -->
	<h2 class="featurette-heading">Fotos</h2>
	<?php
	...
	<nav class="pull-right">
		<ul class="pagination">
			<?php
				...
				if(($pc>=1) && ($ant !=0)){
					echo ("<li><a href='".site."/midias/fotos?p=$ant' aria-label='Anterior'>
									<span aria-hidden='true'>&laquo;</span> Anterior
								</a></li>");
					echo ("<li><a href='".site."/midias/fotos?p=$ant'>$ant</a></li>");
				}
								
				echo ("<li class='active'><a href='".site."/midias/fotos?p=$pc'>$pc</a></li>");
								
				if($pc<=$tp){
					echo ("<li><a href='".site."/midias/fotos?p=$prox'>$prox</a></li>");
					echo("<li><a href='".site."/midias/fotos?p=$prox' aria-label='Próximo'>Próximo 
